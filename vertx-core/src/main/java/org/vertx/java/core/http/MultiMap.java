...
public interface MultiMap extends Iterable<Map.Entry<String, String>> {
   ...
   * @return {@code this}
   */
  MultiMap add(String name, Object value);
   ...
   * @return {@code this}
   */
  MultiMap add(String name, Iterable<?> values);
   ...
   * {@link String} by {@link Object#toString()}.
   *
   * @param name The name
   * @param value The value
   * @return {@code this}
   */
  MultiMap set(String name, Object value);
   ...
   * @return {@code this}
   */
  MultiMap set(String name, Iterable<?> values);
   ...
   * @return {@code this}
   */
  MultiMap set(Map<String, ? extends Object> headers);
